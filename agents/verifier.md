...
### 3. Verify by absence
This is the most important check. The Executor often "fixes 9 out of 10 instances" of a pattern. Verify the fix is complete by grepping for the OLD pattern — it must return zero results.
